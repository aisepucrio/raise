  ...
  return (
    <button
      ...
      className={cn(
        ...
        "hover:filter-[brightness(0.96)] active:filter-[brightness(0.92)] disabled:cursor-not-allowed disabled:bg-(--color-form-disabled-bg) disabled:text-(--color-form-disabled-text) disabled:filter-none",
